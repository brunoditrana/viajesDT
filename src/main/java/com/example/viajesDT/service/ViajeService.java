...
public class ViajeService implements IViajeService{
   ...
   //metodo para consultar todos los viajes no realizados
    ...
    public List<ViajeDTO> findAllViajesPendientes() {
        ...
        List<ViajeDTO> allViajes = viajeAdapter.findAllViajesPendientes();
        List<ViajeDTO> viajesPendientes = new ArrayList<>();


        for (ViajeDTO viaje: allViajes) {

            if (viaje.getFechaSalida().after(new Date())){
